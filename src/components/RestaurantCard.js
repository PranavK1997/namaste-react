...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="m-4 p-4 w-[200px] rounded-lg bg-gray-100 hover:bg-gray-200 shadow-sm hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out cursor-pointer">
      <img
